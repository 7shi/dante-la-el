...
* **Lo giorno se n'andava:** "Lo" è un articolo determinativo maschile singolare, quindi il lemma è "il". "Giorno" è un sostantivo maschile singolare, quindi il lemma è "giorno". "Se n'andava" è la forma imperfetta del verbo "andare", quindi il lemma è "andare".
...
Per quanto riguarda il lemma, ho considerato la forma indefinita o singolare del termine, a seconda del caso. Ad esempio, il lemma di "apparecchiava" è "apparecchiare", mentre il lemma di "pietate" è "pietà".
...
Per quanto riguarda il lemma, ho considerato la forma indefinita o singolare del termine, a seconda del caso. Ad esempio, il lemma di "era" è "essere", mentre il lemma di "donna" è "donna".
...
Per quanto riguarda il lemma, ho considerato la forma indefinita o singolare del termine, a seconda del caso. Ad esempio, il lemma di "temo" è "temere", mentre il lemma di "cielo" è "cielo".
...
Per quanto riguarda il lemma, ho considerato la forma indefinita o singolare del termine, a seconda del caso. Ad esempio, il lemma di "quando" è "quando", mentre il lemma di "che" è "che".
...
Per quanto riguarda il lemma, ho considerato la forma indefinita o singolare del termine, a seconda del caso. Ad esempio, il lemma di "tu" è "tu", mentre il lemma di "che" è "che".
...
Per quanto riguarda il lemma, ho considerato la forma indefinita o singolare del termine, a seconda del caso. Ad esempio, il lemma di "Lucia" è "Lucia", mentre il lemma di "e" è "e".
...
| tanto,      | tanto       | so much,            |
| ch'uscì      | uscire      | that he went out    |
| per         | per         | for                 |
| te          | te          | you                 |
| de          | da          | from                |
| la          | la          | the                 |
...
> After she had reasoned with me this,
> she turned her shining eyes, weeping,
> which made me more eager to come.

I have used the infinitive or singular form of the lemma for each word. For example, "m'ebbe" is the first-person singular past perfect indicative form of the verb "avere," but the lemma is "avere." Similarly, "li" is the masculine plural definite article, but the lemma is "il."

I have also provided a more literal translation of the passage. A more idiomatic translation would be:

> After she had said this to me,
> she turned her bright, tear-filled eyes,
> which made me eager to come more quickly.
...
| te | te | you |
| così | così | so |
| com'ella | come ella | as she |
| volse | volere | wished |
| d'inanzi | dinanzi | from before |
| a | a | to |
| quella | quel | that |
| fiera | fiera | beast |
| ti | ti | you |
...
> that took from you the short journey
> from the beautiful mountain.

I have used the infinitive or singular form of the lemma for each word. For example, "venni" is the first-person singular past indicative form of the verb "venire," but the lemma is "venire." Similarly, "d'inanzi" is the feminine singular preposition, but the lemma is "dinanzi."

I have also provided a more literal translation of the passage. A more idiomatic translation would be:

> And I came to you just as she wanted:
> I rescued you from that beast
> that prevented you from reaching the beautiful mountain.
...
| perché | perché | why |
| perché | perché | why |
| restai | restare | remained |
| perché | perché | why |
| tanta | tanto | so much |
| viltà | viltà | cowardice |
| nel | nel | in the |
| core | cuore | heart |
| allette | allettare | entices |
| perché | perché | why |
...
> So: why is it, why did you stay,
> why does so much cowardice entice your heart,
> why do you not have courage and frankness,

I have used the infinitive or singular form of the lemma for each word. For example, "restai" is the first-person singular past indicative form of the verb "restare," but the lemma is "restare." Similarly, "nel" is the masculine singular preposition, but the lemma is "nel."

I have also provided a more literal translation of the passage. A more idiomatic translation would be:

> So: why is it, why did you stay behind,
> why does such cowardice tempt your heart,
> why do you lack courage and honesty,
...
> Then, since such three blessed women
> care for you in the court of heaven,
> and my speech promises you so well?"

I have used the infinitive or singular form of the lemma for each word. For example, "curan" is the third-person plural present indicative form of the verb "curare," but the lemma is "curare." Similarly, "ne" is the preposition "in" in the feminine singular form, but the lemma is "in."

I have also provided a more literal translation of the passage. A more idiomatic translation would be:

> So, since such three blessed women
> are concerned for you in the heavenly court,
...
| sol | sole | sun |
| li | li | them |
| 'mbianca | imbiancare | whitens |
| si | si | they |
| drizzan | drizzarsi | straighten up |
| tutti | tutto | all |
| aperti | aprire | open |
| in | in | in |
| loro | loro | their |
...
> Like flowerets bent and closed by the night frost,
> then, when the sun whitens them,
> they straighten up all open on their stem,

I have used the infinitive or singular form of the lemma for each word. For example, "chinati" is the past participle of the verb "chinare," but the lemma is "chinare." Similarly, "in" is the preposition "in" in the masculine singular form, but the lemma is "in."

I have also provided a more literal translation of the passage. A more idiomatic translation would be:

> Like flowerets that are bent and closed by the night frost,
> but then open up when the sun shines,
> so I, too, will rise up and open my heart,
> now that the light of truth has come to me.

This translation is based on the interpretation that the speaker is comparing himself to the flowerets. The flowerets are initially bent and closed, but the sun's warmth causes them to open up. Similarly, the speaker is initially hesitant and fearful, but the truth has given him the courage to stand up for himself.

Of course, there are other possible interpretations of this passage. For example, it could be seen as a metaphor for the human soul, which is initially closed off to the divine, but then opens up to God's love.
...
> Such made I myself of my virtue weary,
> and so much good daring ran to my heart,
> that I began like a frank person:

I have used the infinitive or singular form of the lemma for each word. For example, "fec'io" is the first-person singular past indicative form of the verb "fare," but the lemma is "fare." Similarly, "al" is the masculine singular preposition, but the lemma is "a."

I have also provided a more literal translation of the passage. A more idiomatic translation would be:

> My fear and exhaustion gave way to courage,
> and I spoke out frankly:
...
> Oh merciful she who helped me!
> And you courteous one who quickly obeyed
> the true words that she offered you!

I have used the infinitive or singular form of the lemma for each word. For example, "soccorse" is the third-person singular past perfect indicative form of the verb "soccorrere," but the lemma is "soccorrere." Similarly, "le" is the feminine plural definite article, but the lemma is "il."
...
| nel | nel | in the |
| primo | primo | first |
| proposto | proporre | proposal |

**Translation:**

> You have prepared my heart with desire
> to come with your words,
> so much that I have returned to my first proposal.

I have used the infinitive or singular form of the lemma for each word. For example, "hai" is the second-person singular present indicative form of the verb "avere," but the lemma is "avere." Similarly, "ch'i'" is the first-person singular present indicative form of the verb "essere," but the lemma is "essere."

I have also provided a more literal translation of the passage. A more idiomatic translation would be:

> Your words have filled my heart with such a desire to come with you,
> that I have returned to my original plan.
...
> Now go, for our wills are one:
> You are my leader, my lord, and my master."
> So I said to him; and when he had moved,

I have used the infinitive or singular form of the lemma for each word. For example, "va" is the second-person singular imperative form of the verb "andare," but the lemma is "andare." Similarly, "tu" is the second-person singular subject pronoun, but the lemma is "tu."

I have also provided a more literal translation of the passage. A more idiomatic translation would be:

> Now go, for we both want this:
> You are my guide, my lord, and my teacher."
> So I said to him; and when he had started,
...
| alto | alto | high |
| e | e | and |
| silvestro | silvestre | wild |

**Translation:**

> I entered through the high and wild path.

I have used the infinitive or singular form of the lemma for each word. For example, "intrai" is the first-person singular past indicative form of the verb "entrare," but the lemma is "entrare." Similarly, "lo" is the masculine singular definite article, but the lemma is "il."
